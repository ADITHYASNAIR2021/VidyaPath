              ...
              {chapter.googleFormUrl ? (
                <div>
                  <p className="text-sm text-[#4A4A6A] mb-4">
                    Test your knowledge with MCQs prepared by your teacher!
                  </p>
                  <a
                    href={chapter.googleFormUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-saffron-500 hover:bg-saffron-600 active:scale-95 text-white font-semibold text-sm px-5 py-2.5 rounded-xl transition-all shadow-sm"
                  >
                    Start Quiz
