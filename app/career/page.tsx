...
export default function CareerPage() {
  ...
  const filteredExams = ENTRANCE_EXAMS.filter(
    (e) => e.stream === stream || e.stream === 'Both'
  );
  const filteredColleges = TOP_COLLEGES.filter(
    (c) => c.stream === stream || c.stream === 'Both'
  );
  const roadmap = stream === 'PCM' ? ROADMAP_PCM : ROADMAP_PCB;
    ...
    >
      ...
      <div className="bg-gradient-to-br from-purple-700 to-purple-900 text-white px-4 py-12">
        <div className="max-w-5xl mx-auto">
          <h1 className="font-fraunces text-3xl sm:text-4xl font-bold mb-2">
            Career Guide
          </h1>
          <p className="text-purple-200 text-base max-w-xl">
            JEE, NEET, CUET, BITSAT — all the information you need to plan your path after Class 12.
            Free resources, scholarship links, and a year-by-year roadmap.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-3 gap-6">
          {/* Left: Exams + Roadmap (2/3) */}
          <div className="lg:col-span-2 space-y-8">
            {/* Entrance Exams */}
            <div>
              <h2 className="font-fraunces text-2xl font-bold text-navy-700 mb-4">
                Entrance Exams for {stream === 'PCM' ? 'Engineering' : 'Medical'}
              </h2>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-[#E8E4DC] shadow-sm p-5">
              ...
              <div className="space-y-2">
                {[
                  { name: 'Physics Wallah (PW)', desc: 'Best free coaching in India', url: 'https://www.pw.live' },
                  { name: 'Khan Academy India', desc: 'Math & Science concepts', url: 'https://in.khanacademy.org' },
                  { name: 'DoubtNut', desc: 'Instant doubt solving', url: 'https://www.doubtnut.com' },
            ...
            <div className="bg-white rounded-2xl border border-[#E8E4DC] shadow-sm p-5">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { name: 'CUET', url: 'https://cuet.samarth.ac.in' },
