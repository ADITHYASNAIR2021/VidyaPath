...
export const ENTRANCE_EXAMS: EntranceExam[] = [
  ...
  },
  {
    ...
    name: 'VITEEE',
    stream: 'PCM',
    forColleges: 'VIT Vellore, Chennai, Bhopal, Amaravati (B.Tech)',
    eligibility: '60% aggregate in PCM/PCB in Class 12 (50% for reserved categories).',
    pattern: 'Online CBT | Maths/Biology + Physics + Chemistry + Aptitude + English | 125 Questions | No negative marking',
    dates: 'April (slot booking after results) | Registration: November–March',
    officialUrl: 'https://viteee.vit.ac.in',
    topColleges: ['VIT Vellore', 'VIT Chennai', 'VIT Bhopal', 'VIT Amaravati'],
    prepTip: 'No negative marking — attempt every question. NCERT-level difficulty; solve VITEEE PYQs and focus on speed. Aptitude and English are easy scoring sections.',
  },
  {
    id: 'srmjeee',
    name: 'SRMJEEE',
    stream: 'PCM',
    forColleges: 'SRM Institute (Kattankulathur, Ramapuram, NCR, AP)',
    eligibility: '60% aggregate in PCM in Class 12.',
    pattern: 'Online CBT | Physics + Chemistry + Maths/Biology + English + Aptitude | No negative marking',
    dates: 'Three phases: April, June, July',
    officialUrl: 'https://www.srmist.edu.in',
    topColleges: ['SRM Kattankulathur', 'SRM Ramapuram', 'SRM NCR Ghaziabad'],
    prepTip: 'Multiple attempt phases — best score counts. NCERT-based; aptitude and English boost rank. Apply early for better counselling slots.',
  },
  {
    id: 'met-manipal',
    name: 'MET (Manipal)',
    stream: 'PCM',
    forColleges: 'Manipal Institute of Technology (MIT Manipal, Bengaluru)',
    eligibility: '50% aggregate in PCM/PCB + English in Class 12.',
    pattern: 'Online CBT | Physics + Chemistry + Maths + English + Aptitude | Remote-proctored option',
    dates: 'Multiple attempts: April–May',
    officialUrl: 'https://manipal.edu/mu/admission.html',
    topColleges: ['MIT Manipal', 'MIT Bengaluru'],
    prepTip: 'MIT Manipal is among the best private engineering colleges. NCERT + standard reference books; practice the aptitude section which many candidates ignore.',
  },
  {
    id: 'comedk',
    name: 'COMEDK UGET',
    stream: 'PCM',
    forColleges: '190+ private engineering colleges in Karnataka',
    eligibility: '45% aggregate in PCM in Class 12 (40% for reserved).',
    pattern: 'Online CBT | Physics + Chemistry + Maths | 180 Questions | No negative marking',
    dates: 'May | Results & counselling: June–July',
    officialUrl: 'https://www.comedk.org',
    topColleges: ['RV College of Engineering', 'BMS College of Engineering', 'MS Ramaiah Institute', 'PES University'],
    prepTip: 'No negative marking — attempt all 180. Karnataka private college gateway. NCERT + solving PYQs; physics and chemistry are scoring.',
  },
  {
    id: 'wbjee',
    name: 'WBJEE',
    stream: 'PCM',
    forColleges: 'Govt & private engineering colleges in West Bengal (Jadavpur, etc.)',
    eligibility: 'Passed Class 12 with PCM. Domicile rules apply for state quota.',
    pattern: 'Pen & Paper | Paper 1 (Maths) + Paper 2 (Physics + Chemistry) | Differential marking',
    dates: 'April–May | Results: June',
    officialUrl: 'https://wbjeeb.nic.in',
    topColleges: ['Jadavpur University', 'IIEST Shibpur (partial)', 'Kalyani Govt Engineering College'],
    prepTip: 'Jadavpur University CSE is a top target. Differential marking (1 and 2 mark questions) — manage time across difficulty. NCERT + West Bengal board level.',
  },
  {
    id: 'mht-cet',
    name: 'MHT-CET',
    stream: 'PCM',
    forColleges: 'Maharashtra govt & private engineering and pharmacy colleges',
    eligibility: '50% in PCM (45% reserved). Maharashtra domicile for state quota.',
    pattern: 'Online CBT | PCM (or PCB for Pharmacy) | ~20% weight from Class 11 syllabus | No negative marking',
    dates: 'April–May | CAP counselling: June onwards',
    officialUrl: 'https://cetcell.mahacet.org',
    topColleges: ['COEP Pune', 'VJTI Mumbai', 'ICT Mumbai (partial)', 'PICT Pune'],
    prepTip: 'Class 11 syllabus carries ~20% weight — don\'t skip it. No negative marking. Maharashtra State Board + NCERT alignment; speed matters.',
  },
  {
    id: 'kcet',
    name: 'KCET',
    stream: 'PCM',
    forColleges: 'Karnataka govt & aided engineering, agriculture, pharmacy seats',
    eligibility: 'Passed Class 12 with PCM. Karnataka domicile for state quota.',
    pattern: 'Pen & Paper | Physics + Chemistry + Maths (+ Biology for some) | No negative marking',
    dates: 'April | Results & counselling: May–June',
    officialUrl: 'https://cetonline.karnataka.gov.in/kea',
    topColleges: ['UVCE Bangalore', 'Govt engineering colleges (Karnataka)'],
    prepTip: 'No negative marking — attempt everything. Karnataka II PUC + NCERT. Keep your II PUC marks strong; final rank weighs board + KCET equally.',
  },
  {
    id: 'eamcet',
    name: 'AP/TS EAPCET (EAMCET)',
    stream: 'PCM',
    forColleges: 'Engineering & agriculture colleges in Andhra Pradesh & Telangana',
    eligibility: '45% in PCM (relaxation for reserved). State domicile for quota.',
    pattern: 'Online CBT | Engineering (PCM) or Agriculture/Medical (PCB) stream | No negative marking',
    dates: 'May | Counselling: June–July',
    officialUrl: 'https://cets.apsche.ap.gov.in',
    topColleges: ['JNTU Hyderabad', 'JNTU Kakinada', 'Andhra University', 'OU Hyderabad'],
    prepTip: 'State board (AP/TS) + NCERT. No negative marking. Maths is heavily weighted for engineering rank — practice speed-based problem solving.',
  },
  {
    id: 'iat-iiser',
    name: 'IISER Aptitude Test (IAT)',
    stream: 'Both',
    forColleges: 'IISERs (Pune, Kolkata, Mohali, Bhopal, Thiruvananthapuram, Berhampur, Tirupati)',
    eligibility: '60% in Class 12 (PCM/PCB). For 5-year BS-MS dual degree in pure sciences.',
    pattern: 'Online CBT | Physics + Chemistry + Biology + Maths | 60 Questions | Negative marking',
    dates: 'May–June | Results: June',
    officialUrl: 'https://www.iiseradmission.in',
    topColleges: ['IISER Pune', 'IISER Kolkata', 'IISER Mohali', 'IISER Bhopal'],
    prepTip: 'For students who love pure science & research, not engineering/medicine. NCERT + JEE/NEET-level conceptual depth. Strong research-career and PhD pipeline.',
  },
  {
    id: 'nest',
    name: 'NEST',
    stream: 'Both',
    forColleges: 'NISER Bhubaneswar & UM-DAE CEBS Mumbai (5-year Int. MSc)',
    eligibility: '60% in Class 12 (PCM/PCB). For integrated MSc in basic sciences.',
    pattern: 'Online CBT | General + Physics + Chemistry + Biology + Maths (best 3 of 4 sections) | Negative marking',
    dates: 'June | Results: July',
    officialUrl: 'https://www.nestexam.in',
    topColleges: ['NISER Bhubaneswar', 'UM-DAE CEBS Mumbai'],
    prepTip: 'Excellent funded research path (DAE scholarships, INSPIRE). Best 3 of 4 science sections count — play to your strengths. Conceptual NCERT mastery wins.',
  },
  {
    id: 'icar-aieea',
    name: 'ICAR / CUET (Agriculture)',
    stream: 'Both',
    forColleges: 'Agricultural universities & ICAR institutes (BSc Agriculture, Horticulture, Forestry)',
    eligibility: 'Class 12 with PCB/PCM/Agriculture. Admission via CUET-UG (ICAR seats).',
    pattern: 'CUET-UG domain subjects (Agriculture/Biology/Chemistry) | MCQ | Online CBT',
    dates: 'Aligned with CUET-UG: May–June',
    officialUrl: 'https://icar.org.in',
    topColleges: ['IARI Delhi (UG via partner)', 'GB Pant University', 'PAU Ludhiana', 'TNAU Coimbatore'],
    prepTip: 'Agriculture is a fast-growing, under-rated field (agritech, food tech, govt jobs). Now routed through CUET-UG — prepare Biology/Agriculture domain papers.',
  },
  {
    id: 'nda',
    name: 'NDA (UPSC)',
    stream: 'Both',
    forColleges: 'National Defence Academy → Army, Navy, Air Force officer training',
    eligibility: 'Unmarried; Class 12 pass. PCM required for Navy/Air Force. Age ~16.5–19.5. (Women now eligible.)',
    pattern: 'Written: Maths (300) + General Ability (600) | Then SSB Interview (900) — 5-day personality & officer assessment',
    dates: 'Two cycles/year | Written: April & September | UPSC notification',
    officialUrl: 'https://upsc.gov.in',
    topColleges: ['National Defence Academy, Khadakwasla', 'Indian Naval Academy', 'Air Force Academy'],
    prepTip: 'A fully-funded officer career with stipend. Maths + GK + English for the written; SSB tests leadership, not just marks. Build fitness and current-affairs habit early.',
  },
  {
    id: 'jee-barch-nata',
    name: 'B.Arch — NATA / JEE Paper 2',
    stream: 'PCM',
    forColleges: 'Architecture programmes (SPAs, NITs, IITs via JEE Paper 2)',
    eligibility: '50% in Class 12 with Maths as a subject (PCM preferred).',
    pattern: 'NATA: Drawing + Aptitude + PCM reasoning | JEE Main Paper 2: Maths + Aptitude + Drawing',
    dates: 'NATA: multiple sessions (April–July) | JEE Paper 2: Jan & April',
    officialUrl: 'https://www.nata.in',
    topColleges: ['SPA Delhi', 'SPA Bhopal', 'IIT Roorkee (Arch)', 'NIT Calicut (Arch)', 'CEPT Ahmedabad'],
    prepTip: 'Architecture blends design + engineering. Build a sketching habit early; aptitude tests visualisation. Maths is compulsory. Strong portfolio helps for private schools.',
  },
  {
    id: 'uceed-nid-nift',
    name: 'Design — UCEED / NID DAT / NIFT',
    stream: 'Both',
    forColleges: 'IITs (B.Des), NIDs, NIFTs and top design schools',
    eligibility: 'Class 12 (any stream) pass/appearing. Specific cutoffs per institute.',
    pattern: 'UCEED: visualisation + reasoning + design aptitude | NID DAT & NIFT: written + studio/situation test + interview',
    dates: 'UCEED: January | NID DAT: December–January | NIFT: February',
    officialUrl: 'https://www.uceed.iitb.ac.in',
    topColleges: ['IIT Bombay (IDC)', 'NID Ahmedabad', 'NIFT Delhi', 'IIT Hyderabad (Design)', 'Srishti Bangalore'],
    prepTip: 'Design is open to ALL streams — huge scope in UX, product, fashion, animation, communication design. Build a sketchbook, observe everyday objects, practice timed visual problems.',
  },
  {
    id: 'clat-ailet',
    name: 'Law — CLAT / AILET',
    stream: 'Both',
    forColleges: '24 National Law Universities + top private law schools (5-year integrated LLB)',
    eligibility: '45% in Class 12 (any stream). 40% for reserved categories.',
    pattern: 'CLAT: English + Current Affairs/GK + Legal Reasoning + Logical Reasoning + Quant | AILET: similar (NLU Delhi)',
    dates: 'CLAT: December | AILET: December',
    officialUrl: 'https://consortiumofnlus.ac.in',
    topColleges: ['NLSIU Bangalore', 'NALSAR Hyderabad', 'WBNUJS Kolkata', 'NLU Delhi (AILET)', 'GNLU Gandhinagar'],
    prepTip: 'Law suits strong readers/debaters from any stream. Read newspapers daily (The Hindu / Indian Express), build legal-reasoning and comprehension speed. NLSIU = top target.',
  },
  {
    id: 'nchm-jee',
    name: 'NCHM JEE (Hotel Management)',
    stream: 'Both',
    forColleges: 'Institutes of Hotel Management (IHMs) — B.Sc Hospitality & Hotel Administration',
    eligibility: 'Class 12 pass (any stream) with English.',
    pattern: 'Online CBT (via NTA) | Numerical + Reasoning + GK + English + Aptitude for Service Sector',
    dates: 'April–May | Counselling: June',
    officialUrl: 'https://nchm.nta.nic.in',
    topColleges: ['IHM Pusa Delhi', 'IHM Mumbai', 'IHM Chennai', 'IHM Bangalore'],
    prepTip: 'Hospitality is a global, people-first career (hotels, aviation, cruise, events). General aptitude + English + service-attitude. Any stream eligible — no science needed.',
  },
  {
    id: 'imu-cet',
    name: 'IMU CET (Merchant Navy)',
    stream: 'PCM',
    forColleges: 'Indian Maritime University & affiliated marine colleges (B.Tech Marine, BSc Nautical Science)',
    eligibility: '60% in PCM + good eyesight & medical fitness. Age limits apply.',
    pattern: 'Online CBT | Physics + Chemistry + Maths + English + GK + Aptitude',
    dates: 'May–June',
    officialUrl: 'https://www.imu.edu.in',
    topColleges: ['IMU Chennai', 'IMU Kolkata', 'IMU Mumbai Port', 'TS Chanakya'],
    prepTip: 'High-paying seafaring career; medical fitness & eyesight are mandatory gates. PCM + English. Research sponsorship/placement of the marine college before joining.',
  },
  {
    id: 'npat-set',
    name: 'NPAT / SET (Private Universities)',
    stream: 'Both',
    forColleges: 'NMIMS, Symbiosis (SLS, SSE), and allied programmes (BBA, B.Com, BSc, B.Tech, BA)',
    eligibility: 'Class 12 pass/appearing (any stream). Programme-specific cutoffs.',
    pattern: 'NPAT: Quantitative + Reasoning + English | SET: General Knowledge + Quant + Verbal + Analytical',
    dates: 'NPAT: Jan–May (multiple) | SET: May',
    officialUrl: 'https://www.nmimsnpat.in',
    topColleges: ['NMIMS Mumbai', 'Symbiosis (SCMS, SLS Pune)', 'NMIMS Bangalore'],
    prepTip: 'Gateway to strong private BBA/B.Com/management programmes. Aptitude-style prep (quant + verbal + reasoning); multiple attempt windows — book the earliest slot.',
  },
];
...
export const TOP_COLLEGES: College[] = [
  ...
  // More engineering (PCM)
  { name: 'IIT Roorkee', tier: 'Elite', stream: 'PCM', url: 'https://www.iitr.ac.in' },
  { name: 'IIT Guwahati', tier: 'Elite', stream: 'PCM', url: 'https://www.iitg.ac.in' },
  { name: 'IIT Hyderabad', tier: 'Elite', stream: 'PCM', url: 'https://www.iith.ac.in' },
  { name: 'NIT Surathkal (Karnataka)', tier: 'Top', stream: 'PCM', url: 'https://www.nitk.ac.in' },
  { name: 'NIT Calicut', tier: 'Top', stream: 'PCM', url: 'https://www.nitc.ac.in' },
  { name: 'IIIT Bangalore', tier: 'Top', stream: 'PCM', url: 'https://www.iiitb.ac.in' },
  { name: 'Jadavpur University', tier: 'Top', stream: 'PCM', url: 'https://www.jaduniv.edu.in' },
  { name: 'DTU (Delhi Technological University)', tier: 'Top', stream: 'PCM', url: 'https://dtu.ac.in' },
  { name: 'NSUT Delhi', tier: 'Top', stream: 'PCM', url: 'https://www.nsut.ac.in' },
  { name: 'COEP Pune', tier: 'Good', stream: 'PCM', url: 'https://www.coep.org.in' },
  { name: 'VIT Vellore', tier: 'Good', stream: 'PCM', url: 'https://vit.ac.in' },
  // More medical (PCB)
  { name: 'AIIMS (other INIs)', tier: 'Elite', stream: 'PCB', url: 'https://www.aiims.edu' },
  { name: 'CMC Vellore', tier: 'Elite', stream: 'PCB', url: 'https://www.cmch-vellore.edu' },
  { name: 'Maulana Azad Medical College', tier: 'Top', stream: 'PCB', url: 'https://www.mamc.ac.in' },
  { name: 'King George\'s Medical Univ (KGMU)', tier: 'Top', stream: 'PCB', url: 'https://www.kgmu.org' },
  { name: 'Grant Medical College Mumbai', tier: 'Good', stream: 'PCB', url: 'https://www.ggmcjjh.org' },
  { name: 'BHU Institute of Medical Sciences', tier: 'Good', stream: 'PCB', url: 'https://www.bhu.ac.in' },
  // More commerce / management
  { name: 'St. Xavier\'s College Mumbai', tier: 'Top', stream: 'Commerce', url: 'https://xaviers.edu' },
  { name: 'NMIMS Mumbai', tier: 'Top', stream: 'Commerce', url: 'https://www.nmims.edu' },
  { name: 'Symbiosis (SCMS) Pune', tier: 'Good', stream: 'Commerce', url: 'https://www.symbiosis.ac.in' },
  { name: 'IIM Indore (IPM)', tier: 'Elite', stream: 'Commerce', url: 'https://www.iimidr.ac.in' },
  // Cross-stream — pure science, research & liberal arts (Both)
  { name: 'IISc Bangalore (BS Research)', tier: 'Elite', stream: 'Both', url: 'https://www.iisc.ac.in' },
  { name: 'IISER Pune', tier: 'Elite', stream: 'Both', url: 'https://www.iiserpune.ac.in' },
  { name: 'IISER Kolkata', tier: 'Top', stream: 'Both', url: 'https://www.iiserkol.ac.in' },
  { name: 'NISER Bhubaneswar', tier: 'Top', stream: 'Both', url: 'https://www.niser.ac.in' },
  { name: 'Ashoka University (Liberal Arts)', tier: 'Top', stream: 'Both', url: 'https://www.ashoka.edu.in' },
  { name: 'NLSIU Bangalore (Law)', tier: 'Elite', stream: 'Both', url: 'https://www.nls.ac.in' },
  { name: 'NID Ahmedabad (Design)', tier: 'Elite', stream: 'Both', url: 'https://www.nid.edu' },
  { name: 'University of Delhi (CUET)', tier: 'Top', stream: 'Both', url: 'https://www.du.ac.in' },
];
...
export const SCHOLARSHIPS: Scholarship[] = [
  ...
  { name: 'Central Sector Scheme of Scholarships', description: 'For top Class 12 performers pursuing graduation. ₹12,000–20,000/year via NSP.', url: 'https://scholarships.gov.in' },
  { name: 'NMMS (National Means-cum-Merit)', description: 'For meritorious students (Class 9–12) from economically weaker families. ₹12,000/year.', url: 'https://scholarships.gov.in' },
  { name: 'PM Scholarship Scheme (PMSS)', description: 'For wards of ex-servicemen / armed forces personnel pursuing professional degrees.', url: 'https://www.ksb.gov.in' },
  { name: 'Reliance Foundation UG Scholarships', description: 'Merit-cum-means for undergraduates across streams. Up to ₹2 lakh.', url: 'https://www.reliancefoundation.org' },
  { name: 'Aditya Birla / Tata / Sitaram Jindal Trusts', description: 'Private merit & need-based scholarships for college students across India.', url: 'https://www.buddy4study.com' },
  { name: 'Pragati Scholarship (AICTE)', description: 'For girl students in AICTE-approved technical (engineering) programmes. ₹50,000/year.', url: 'https://www.aicte-india.org/schemes/students-development-schemes' },
  { name: 'Saksham Scholarship (AICTE)', description: 'For specially-abled students in AICTE technical programmes. ₹50,000/year.', url: 'https://www.aicte-india.org/schemes/students-development-schemes' },
  { name: 'State Merit & Fee-Reimbursement Schemes', description: 'Most states fund post-matric/college fees for SC/ST/OBC/EWS students — check your state portal.', url: 'https://scholarships.gov.in' },
];
