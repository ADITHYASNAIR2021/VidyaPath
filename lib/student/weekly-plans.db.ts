...
export interface StudentWeeklyPlansSession {
  classLevel: 10 | 12;
  schoolId: string;
  section?: string;
...
function buildAllowedSubjectSet(session: StudentWeeklyPlansSession): Set<string> {
...
export async function listVisibleWeeklyPlansForStudent(
  session: StudentWeeklyPlansSession,
  limit: number
